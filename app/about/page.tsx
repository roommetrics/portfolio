...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white">
      <main className="container mx-auto max-w-6xl px-6 lg:px-8 py-20 lg:py-28">
        {/* Hero */}
        <section className="text-center mb-12 sm:mb-14 md:mb-16">
          ...
          <div className="w-16 sm:w-20 lg:w-24 h-[3px] bg-gradient-to-r from-primary to-blue-400 rounded-full mx-auto mt-6" />
        </section>
        ...
        <section className="grid grid-cols-12 gap-8 lg:gap-12 items-start mb-16 lg:mb-24">
          ...
          <div className="col-span-12 lg:col-span-7 order-2">
            <div className="space-y-5 text-white/80 text-base sm:text-lg">
              <p>
        ...
        <section className="mb-16 lg:mb-24">
          <h2 className="text-2xl sm:text-3xl font-bold mb-6 text-white">Werte & Arbeitsweise</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
            {[{
              ...
              <div key={v.title} className="bg-white/[0.06] border border-white/10 rounded-2xl p-6 hover:bg-white/[0.08] transition-colors">
        ...
        {/* Prozess */}
        <section className="mb-16 lg:mb-24">
          <h2 className="text-2xl sm:text-3xl font-bold mb-6 text-white">Ablauf in 4 Schritten</h2>
          <ol className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
            {[
              ...
              { step: '2', title: 'Konzept & Design', text: 'Struktur und Erscheinungsbild – passend zu Ihrem Unternehmen.' },
              ...
              <li key={s.title} className="relative bg-white/[0.06] border border-white/10 rounded-2xl p-6">
